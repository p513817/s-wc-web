...
class YOLO(DetectionModel):
    ...
    def postprocess(self, outputs, meta):
        """ The postprocess of YOLO and YOLOv4 is the same
        1. _parse_outputs       -> _parse_yolo_region
        2. _resize_detections   -> 
        """
    ...
    def _parse_yolo_region(self, predictions, input_size, params):
        ...
        for prediction in predictions:
            ...
            for ind, obj_ind in enumerate(obj_indx):
                ...
                xmin = predicted_box.x - predicted_box
                ymin = predicted_box.y - predicted_box
                xmax = predicted_box.x + predicted_box
                ymax = predicted_box.y + predicted_box
                ...
                objects.append(Detection(predicted_box.x - predicted_box.w / 2,
                                         ...
                                         predicted_box.y + predicted_box.h / 2,
                                         confidence.item(), index.item(), label))
